...
/**
 * This is the our Datastore utility class for access to datastore APIs for all servlets. 
 * It provides method for inserting, deleting, searching the entity from data store. 
 */
public class DatastoreAPI {

	 private static final Logger logger = Logger.getLogger(DatastoreAPI.class.getCanonicalName());
